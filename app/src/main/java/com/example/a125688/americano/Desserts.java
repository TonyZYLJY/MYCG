...
public class Desserts extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        im1 = R.drawable.biscotti;
        im2 = R.drawable.brownies;
        im3 = R.drawable.cupcake;
        im4 = R.drawable.cheese;
        im5 = R.drawable.cookies;
        im6 = R.drawable.muffin;
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                details.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (myProduct.getDescription().equals("Biscotti")){
                        ...
                        else if (myProduct.getDescription().equals("Brownies")) {
                        ...
                        else if (myProduct.getDescription().equals("Carrot C.Cake")) {
                        ...
                        else if (myProduct.getDescription().equals("Chocolate C.Cake")) {
                        ...
                        else if (myProduct.getDescription().equals("Cookie")) {
                        ...
                        else if (myProduct.getDescription().equals("Muffin")) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.carButton){
            Intent menu = new Intent(Desserts.this, CartPage.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.Menu) {
            Intent menu = new Intent(Desserts.this, com.example.a125688.americano.Menu.class);
            menu.putExtra("userInfo", current_user);
            startActivity(menu);
        } else if (id == R.id.Order_history) {

        } else if (id == R.id.Rewards) {
            Intent rewards = new Intent(Desserts.this, com.example.a125688.americano.Menu.class);
            rewards.putExtra("userInfo", current_user);
            startActivity(rewards);
        } else if (id == R.id.Favorites) {
            Intent favorite = new Intent(Desserts.this, favoritePage.class);
            favorite.putExtra("userInfo", current_user);
            startActivity(favorite);
        } else if (id == R.id.Account) {
            Intent account = new Intent(Desserts.this, AccountPage.class);
            account.putExtra("userInfo", current_user);
            startActivity(account);
        } else if (id == R.id.Log_out) {
            Intent logOut = new Intent(Desserts.this, Home.class);
            startActivity(logOut);
        } else if (id == R.id.About_us){
           Intent aboutUs = new Intent(Desserts.this, aboutUsPage.class);
